...
function TimerDisplay() { 
    ...
    return (
        <div className="h-3/5 w-11/12 flex justify-center items-center mt-7 border-2 border-black rounded-4xl">
            <div id="timer-number-container" className="h-3/5 w-2/3 flex justify-center items-center font-mono overflow-visible">
                <span id="minutes" className="h-full w-3/5 flex justify-center items-center text-9xl">24<span>:</span></span>
                <div id="seconds-container" className="h-full w-2/5 flex flex-col ml-5">
                    <span className="h-2/3 w-full text-8xl overflow-visible">00</span>
